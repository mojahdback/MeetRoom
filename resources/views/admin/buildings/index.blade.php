                ...
                <div class="bg-white rounded-2xl shadow-sm overflow-hidden">
                    <table class="w-full text-sm">
                        ...
                        <tbody class="divide-y divide-gray-50">
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-5 py-3">
                                        @if ($building->is_active)
                                            <span
                                                class="bg-green-100 text-green-600 text-xs font-semibold px-2.5 py-0.5 rounded-full">Actif</span>
                                        @else
                                            <span
                                                class="bg-red-100 text-red-500 text-xs font-semibold px-2.5 py-0.5 rounded-full">Inactif</span>
                                        @endif
                                    </td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="text-center py-8 text-gray-400">Aucun bâtiment.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
