...
<div class="max-w-xl mx-auto py-10 px-4">
    ...
    <a href="index.blade.php" class="inline-flex items-center gap-1 text-sm text-gray-400 hover:text-gray-600 mb-6 transition">
    ...
    <div class="bg-white rounded-2xl shadow-sm p-8">
        ...
        <form method="POST" action="{{ route('buildings.store') }}" class="space-y-5">
             @csrf 
            ...
            <div class="flex items-center gap-2">
                <input type="checkbox" name="is_active" id="is_active" value="1" checked class="accent-blue-500 w-4 h-4"/>
