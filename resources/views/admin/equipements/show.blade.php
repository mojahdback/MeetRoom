        ...
        <div class="bg-white rounded-2xl shadow-sm p-8 mb-6">
            <div class="flex justify-between items-start">
                <div>
                    ...
                    <span
                        class="bg-blue-100 text-blue-600 text-xs font-semibold px-2.5 py-0.5 rounded-full mt-2 inline-block">
                        {{ $equipement->type }}
                    </span>
        ...
        <div class="bg-white rounded-2xl shadow-sm overflow-hidden">
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-50">
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="text-center py-8 text-gray-400">Aucune salle assignée.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
