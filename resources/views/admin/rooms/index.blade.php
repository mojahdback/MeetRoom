                ...
                <tbody class="divide-y divide-gray-50">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-5 py-3 flex gap-3">
                            <a href="{{ route('rooms.show', $room) }}" class="text-sm text-blue-500 hover:underline">Voir</a>
                            <a href="{{ route('rooms.edit', $room) }}" class="text-sm text-yellow-500 hover:underline">Modifier</a>
                    ...
                    @empty
                    <tr><td colspan="6" class="text-center py-8 text-gray-400">Aucune salle.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
