    ...
    <div class="flex">
        ...
        <main class="flex-1 p-8">
            ...
            <div class="mb-8">
                ...
                <p class="text-sm text-gray-400 mt-1">Vue d'ensemble du parc immobilier</p>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
                ...
                <div class="bg-white rounded-2xl shadow-sm p-5">
                    <div class="w-10 h-10 rounded-lg bg-blue-100 flex items-center justify-center mb-3">
                        <svg width="18" height="18" fill="none" stroke="#3b82f6" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round">
                            <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/>
                        </svg>
                    </div>
                    <p class="text-2xl font-bold text-gray-800">{{ $buildings }}</p>
                    <p class="text-sm text-gray-400">Bâtiments</p>
                </div>

                <div class="bg-white rounded-2xl shadow-sm p-5">
                    <div class="w-10 h-10 rounded-lg bg-green-100 flex items-center justify-center mb-3">
                        <svg width="18" height="18" fill="none" stroke="#22c55e" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round">
                            <rect x="3" y="3" width="18" height="18" rx="3"/><path d="M3 9h18M9 21V9"/>
                        </svg>
                    </div>
                    <p class="text-2xl font-bold text-gray-800">{{ $rooms }}</p>
                    <p class="text-sm text-gray-400">Salles</p>
                </div>

                <div class="bg-white rounded-2xl shadow-sm p-5">
                    <div class="w-10 h-10 rounded-lg bg-yellow-100 flex items-center justify-center mb-3">
                        <svg width="18" height="18" fill="none" stroke="#eab308" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round">
                            <rect x="2" y="3" width="20" height="14" rx="2"/><path d="M8 21h8M12 17v4"/>
                        </svg>
                    </div>
                    <p class="text-2xl font-bold text-gray-800">{{ $equipements }}</p>
                    <p class="text-sm text-gray-400">Équipements</p>
                </div>

                <div class="bg-white rounded-2xl shadow-sm p-5">
                    <div class="w-10 h-10 rounded-lg bg-purple-100 flex items-center justify-center mb-3">
                        <svg width="18" height="18" fill="none" stroke="#a855f7" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-5">
                ...
                <div class="bg-white rounded-2xl shadow-sm p-6">
                    <h2 class="font-semibold text-gray-700 mb-4">Salles par bâtiment</h2>
                    <canvas id="buildingChart"></canvas>
                </div>

                <div class="bg-white rounded-2xl shadow-sm p-6">
                    <h2 class="font-semibold text-gray-700 mb-4">Taux d'occupation</h2>
                    <canvas id="tauxDoccupationChart"></canvas>
                </div>
