                ...
                <div class="bg-white rounded-2xl shadow-sm p-5 mb-4 flex items-start justify-between gap-4">
                    <div class="flex-1">
                        <div class="flex items-center gap-2 mb-1">
                            ...
                            <span class="bg-yellow-100 text-yellow-600 text-xs font-semibold px-2.5 py-0.5 rounded-full">En
                                attente</span>
                        </div>
                        <p class="text-sm text-gray-400">🏢 {{ $reservation->room->building->name }} · Étage
                    ...
                    <form method="POST" action="{{ route('employee.reservation.cancel', $reservation->id) }}">
                        @csrf @method('PATCH')
                        <button type="submit" onclick="return confirm('Annuler cette réservation ?')"
